 ...
 * @author Aleksandra
 */
public class FrmAddKorisnik extends javax.swing.JDialog {

    /**
     * Creates new form FrmAddUser
     */
    public FrmAddKorisnik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Dodavanje novog korisnika");
    }
    ...
    private void initComponents() {
        ...
        txtDatumRodjenja.setText("10.10.1999");
    ...
    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
        try {
            ...
            if (txtKontakt.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this,"Sistem ne moze da kreira novog korisnika","Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            Korisnik korisnik = new Korisnik(null, txtIme.getText().trim(), txtPrezime.getText().trim(),
                    sdf.parse(txtDatumRodjenja.getText()), txtKontakt.getText());

            ClientController.getInstance().addKorisnik(korisnik);

            JOptionPane.showMessageDialog(this, "Sistem je kreirao korisnika");
            FrmMain frmMain= new FrmMain();
            //frmMain.popuniKorisnike(new TableModelKorisnik());
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this,"Sistem ne moze da kreira korisnika","Error",
                        JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(FrmAddKorisnik.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAddKorisnik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmAddKorisnik dialog = new FrmAddKorisnik(new javax.swing.JFrame(), true);
